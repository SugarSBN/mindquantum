...
struct CsrHdMatrix {
  ...
  CsrHdMatrix()
      : dim_(0), nnz_(0), indptr_(nullptr), indices_(nullptr), data_(nullptr) {}
  ...
  CsrHdMatrix(Index dim, Index nnz, py::array_t<Index> indptr,
              py::array_t<Index> indices, py::array_t<CT<T>> data)
      : dim_(dim), nnz_(nnz) {
